...
/// <summary>
/// Testes de integracao para verificar que o servico gRPC Index esta configurado corretamente.
/// </summary>
public class IndexGrpcTests : IClassFixture<IndexGrpcTests.GrpcWebAppFactory>, IAsyncLifetime
{
    private readonly GrpcWebAppFactory _factory;
    private const string ValidApiKey = "test-api-key-grpc-index";
    private const string TestEmail = "grpc-index-test@mnemosyne.dev";

    public IndexGrpcTests(GrpcWebAppFactory factory)
    {
        _factory = factory;
    }
    ...
    [Fact(DisplayName = "gRPC Index - Servidor inicia corretamente")]
    [Trait("Layer", "Integration - gRPC")]
    public void IndexGrpcService_ServerStartsSuccessfully()
    {
        // Arrange & Act
