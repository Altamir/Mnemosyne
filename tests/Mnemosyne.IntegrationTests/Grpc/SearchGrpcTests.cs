...
/// <summary>
/// Testes de integracao para verificar que o servico gRPC Search esta configurado corretamente.
/// </summary>
public class SearchGrpcTests : IClassFixture<SearchGrpcTests.GrpcWebAppFactory>, IAsyncLifetime
{
    private readonly GrpcWebAppFactory _factory;
    private const string ValidApiKey = "test-api-key-grpc-search";
    private const string TestEmail = "grpc-search-test@mnemosyne.dev";

    public SearchGrpcTests(GrpcWebAppFactory factory)
    {
        _factory = factory;
    }
    ...
    [Fact(DisplayName = "gRPC Search - Servidor inicia corretamente")]
    [Trait("Layer", "Integration - gRPC")]
    public void SearchGrpcService_ServerStartsSuccessfully()
    {
        // Arrange & Act
